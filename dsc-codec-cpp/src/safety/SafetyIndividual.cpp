...
SafetyIndividual::SafetyIndividual(Mmsi selfId, Mmsi address,
	...
	TimeUTC time) :
	IndividualCall(Phasing(Code(Phasing::Symbol_EOS_ACK_RQ)), selfId, address, Category(Code(Category::Symbol_SAFETY)),
...
std::string SafetyIndividual::toString()
{
